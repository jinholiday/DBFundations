...
-- 2017-01-01,JamesCooper,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_JamesCooper')
	 Begin 
	  Alter Database [Assignment06DB_JamesCooper] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_JamesCooper;
	 End
	Create Database Assignment06DB_JamesCooper;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_JamesCooper;
...
As 
	...
	on dbo.vProducts.ProductID = dbo.vInventories.InventoryID
...
--Order by 1 */ why it's not working? /*
...
As
	Select Top 10000000000
	Mananger = m.EmployeeFirstName + ' ' + m.EmployeeLastName,
	Employee = e.EmployeeFirstName + ' ' + e.EmployeeLastName
	
	From dbo.vEmployees as m
	Join dbo.vEmployees as e
	On e.ManagerID = m.EmployeeID
--Order by Manager, Employee; /* why this is not working*/
Order by 1,2;
Go
